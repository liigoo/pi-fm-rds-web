...
[![Stars](https://img.shields.io/github/stars/liigoo/pi-fm-rds-go?style=social)](https://github.com/liigoo/pi-fm-rds-go)
...
```bash
git clone https://github.com/liigoo/pi-fm-rds-go.git
cd pi-fm-rds-go
go mod download
...
# 2. 启动
ssh pi@<pi-ip> 'nohup /data/pi-fm-rds/pi-fm-rds-server -config /data/pi-fm-rds/config.yaml > /data/pi-fm-rds/server.log 2>&1 &'
```
...
[![Star History Chart](https://api.star-history.com/svg?repos=liigoo/pi-fm-rds-go&type=Date)](https://star-history.com/#liigoo/pi-fm-rds-go&Date)
...
### 4) Raspberry Pi deployment example
